    ...
    <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
      <div className="flex flex-col items-center justify-center space-y-4 text-center">
        ...
        <div className='flex flex-col gap-2 min-[400px]:flex-row justify-center'>
          <div>
<Button variant={'link'} size={'lg'} className='w-full min-[400px]:w-auto bg-linear-to-r from-slate-900 to-rose-500 hover:from-rose-500 hover:to-slate-900 text-white hover:text-white font-semibold px-6 py-3 rounded-lg flex justify-center items-center shadow-md transition-all duration-300 hover:no-underline'>
